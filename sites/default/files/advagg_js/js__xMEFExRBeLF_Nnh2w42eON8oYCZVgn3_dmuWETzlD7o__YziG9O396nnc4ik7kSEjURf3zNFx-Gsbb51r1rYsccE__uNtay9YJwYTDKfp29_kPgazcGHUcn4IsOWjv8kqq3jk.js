...
Drupal.urlIsLocal = function (url) {
  ...
  // as local as well.
  if (protocol === 'http:' && absoluteUrl.indexOf('openconcept-ranks-top-10-b-corps-positive-employee-impact.html') === 0) {
    protocol = 'openconcept-ranks-top-10-b-corps-positive-employee-impact.html';
  }
